...
class AdminSettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        $defaults = [
            ...
            'bunnycdn.embed_hostname' => config('bunnycdn.embed_hostname', 'iframe.mediadelivery.net'),
            'bunnycdn.stream_hostname' => config('bunnycdn.stream_hostname', ''),
        ...
        return response()->json([
            'settings' => [
                ...
                'bunnycdn' => [
                    ...
                    'embed_hostname' => $resolved['bunnycdn.embed_hostname'],
    ...
    public function update(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'bunnycdn.embed_hostname' => 'nullable|string|max:255',
        ...
        $items = [
            ...
            ['key' => 'bunnycdn.embed_hostname', 'value' => data_get($data, 'bunnycdn.embed_hostname')],
