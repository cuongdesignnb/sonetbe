...
class SyncRuntimeSettings
{
    public function handle(Request $request, Closure $next)
    {
        config([
            ...
            'bunnycdn.embed_hostname' => SettingsService::get('bunnycdn.embed_hostname', config('bunnycdn.embed_hostname', 'iframe.mediadelivery.net')),
            'bunnycdn.stream_hostname' => SettingsService::get('bunnycdn.stream_hostname', config('bunnycdn.stream_hostname', '')),
